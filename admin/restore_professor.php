...
if(isset($_POST['restore'])){
    ...
    if($check_query->num_rows == 0) {
        ...
        $sql_restore = "INSERT INTO professor (lastname, firstname, middlename, faculty_id, age, birthday, employment_status, prof_username, prof_password) 
                        VALUES ('".$row['lastname']."', '".$row['firstname']."', '".$row['middlename']."', '".$row['faculty_id']."', '".$row['age']."', '".$row['birthday']."', '".$row['employment_status']."', '".$row['prof_username']."', '".$row['prof_password']."')";
