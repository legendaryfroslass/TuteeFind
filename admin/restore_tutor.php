...
if (isset($_POST['restore'])) {
    ...
    try {
        ...
        if ($query->num_rows > 0) {
            ...
            $sql_restore = "INSERT INTO tutor (id, lastname, firstname, age, sex, number, barangay, student_id, course, year_section, professor, fblink, emailaddress, password, bio, last_login) 
