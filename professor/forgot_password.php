...
if(isset($_POST['submit'])){
    ...
    if(empty($email)){
        ...
        // Check if the entered email belongs to an professor
        $query = "SELECT * FROM professor WHERE emailaddress = ?";
        ...
        if($result->num_rows > 0) {
            ...
            $_SESSION['error'] = "Email not found or does not belong to a Professor";
        }
    }
}
