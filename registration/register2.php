                ...
                <div class="col-md-6 right-box">
                    <div class="row justify-content-center">
                        ...
                        <div class="inputContainer mb-3">
                            <input required="required" maxlength="1" type="text" class="otp-input" name="otp1" id="otp-input1" oninput="moveToNext(this, 'otp-input2')">
                            <input required="required" maxlength="1" type="text" class="otp-input" name="otp2" id="otp-input2" oninput="moveToNext(this, 'otp-input3')">
                            <input required="required" maxlength="1" type="text" class="otp-input" name="otp3" id="otp-input3" oninput="moveToNext(this, 'otp-input4')">
                            <input required="required" maxlength="1" type="text" class="otp-input" name="otp4" id="otp-input4" oninput="moveToNext(this, 'otp-input5')">
                            <input required="required" maxlength="1" type="text" class="otp-input" name="otp5" id="otp-input5" oninput="moveToNext(this, 'otp-input6')">
                            <input required="required" maxlength="1" type="text" class="otp-input" name="otp6" id="otp-input6">
                        </div>
